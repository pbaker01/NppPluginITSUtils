...
namespace ITS.Utils { 
    ...
    public static class ITSConstants
    {
        ...
        public static string[] errorText = {
            ...
            "ERR005 - Check settings - Unisys file: {0} is missing the qualifier",
            "ERR006 - Check settings - Unisys file: {0} contains too many asterisks.",
            "ERR007 - Check settings - Unisys file not specified",
            "ERR008 - Check settings - No environment selected",
            "ERR009 - Check settings - Proc File 1 and Proc File 2 are not specified for the selected environment.",
