...
namespace CsvQuery.PluginInfrastructure
{
    public class SettingsBase
    {
        ...
        {
            // Changed by PB
            IniFilePath = Path.Combine(notepad.GetPluginConfigPath(), Main.PluginName, Main.PluginName + ".ini");
            // MessageBox.Show(IniFilePath); // PB
        }
        ...
        /// </summary>
        public void ShowDialog(string title = "Settings")
        {
